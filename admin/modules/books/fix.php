...
if(is_Post()){
    ...
    if(empty($erorrs)){
        ...
        $statuUpdate = update('book', $dataUpdate, "id='$bookId'");

        if($statuUpdate){
            setFlashData('msg', 'Fix book success !!!');
    ...
    redirect("?module=books&active=fix&id=$bookId#add");
